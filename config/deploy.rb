...
set :application, 'showcase'
set :repo_url, 'git@showcase:darkmane/showcase.git'

set :scm, :git

set :local_user, "deploy"
set :deploy_to, "/var/www/showcase"
set :deploy_via, :copy
set :copy_dir, "/var/tmp/cap_showcase"
set :copy_remote_dir, "/var/tmp/cap_showcase"
